...
// Cuisines: American, Brazilian, Chinese, Ethiopian, French,
//   Greek, Indian, Italian, Japanese, Korean, Lebanese, Mexican,
//   Moroccan, Peruvian, Spanish, Thai, Turkish, Vietnamese,
//   Vegetarian, Vegan + Comfort Food & Adventure
...
const TALULA_OVERRIDES = [
  "Carrot", "Zucchini", "Baby spinach", "Spinach", "Bok choy", "Cabbage", "Leek",
  "Sweet potatoes", "Sweet potato", "Cucumber", "Tomatoes", "Cherry tomatoes",
  "Spring onion", "Cauliflower", "Fresh basil", "Chives", "Fresh sage",
  "Pumpkin, peeled & diced", "Kabocha pumpkin", "Red onion", "Green beans",
  "Bell pepper", "Red bell pepper", "Green bell pepper", "Yellow bell pepper",
  "Capsicum", "Avocado", "Lime", "Lemon", "Lettuce", "Romaine lettuce",
  "Fresh coriander", "Fresh cilantro", "Fresh mint", "Fresh parsley",
  "Fresh dill", "Fresh thyme", "Fresh rosemary", "Lemongrass", "Bean sprouts",
  "Corn on the cob", "Collard greens", "Kale", "Mushrooms", "Broccoli",
  "Celery", "Mango", "Banana", "Watermelon", "Pineapple"
];

// Ingredient category mapping for grocery list organization
const INGREDIENT_CATEGORIES = {
  "Proteins": ["Chicken thigh", "Chicken breast", "Chicken mince", "Chicken drumstick",
    "Chicken wing", "Beef mince", "Beef steak", "Beef sirloin", "Beef strips",
    "Lamb mince", "Lamb", "Pork mince", "Pork belly", "Pork loin", "Pork shoulder",
    "Beef or lamb mince", "Beef or pork mince", "Ground beef", "Ground lamb", "Ground pork",
    "Salmon fillet", "Canned tuna", "Shrimp", "Prawns",
    "Soft tofu", "Firm tofu", "Tofu", "Eggs", "Egg",
    "Black beans", "Chickpeas", "Canned chickpeas", "Lentils", "Red lentils",
    "Green lentils", "Refried beans", "Canned beans", "Dried chickpeas"],
  "Dairy": ["Fresh mozzarella", "Mozzarella", "Parmesan cheese", "Cheddar cheese",
    "Cream cheese", "Feta cheese", "Halloumi", "Gouda", "Gruyère",
    "Butter", "Unsalted butter", "Cream", "Heavy cream", "Sour cream",
    "Milk", "Milk or cream", "Greek yogurt", "Yogurt", "Labneh",
    "Sour cream or applesauce", "Japanese mayonnaise", "Mayonnaise",
    "Paneer", "Ricotta", "Queso fresco", "Manchego"],
  "Produce": ["Carrot", "Zucchini", "Onion", "Red onion", "Garlic", "Baby spinach",
    "Spinach", "Bok choy", "Leek", "Potatoes", "Sweet potatoes", "Sweet potato",
    "Tomatoes", "Cherry tomatoes", "Cucumber", "Cabbage", "Cauliflower",
    "Broccoli", "Bell pepper", "Red bell pepper", "Green bell pepper", "Capsicum",
    "Spring onion", "Fresh basil", "Fresh sage", "Chives", "Fresh coriander",
    "Fresh cilantro", "Fresh mint", "Fresh parsley", "Fresh dill", "Fresh thyme",
    "Fresh rosemary", "Pumpkin, peeled & diced", "Kabocha pumpkin", "Ginger",
    "Avocado", "Lime", "Lemon", "Lettuce", "Romaine lettuce", "Corn on the cob",
    "Bean sprouts", "Lemongrass", "Collard greens", "Kale", "Mushrooms",
    "Celery", "Mango", "Banana", "Watermelon", "Pineapple", "Green beans",
    "Eggplant"],
  "Pantry": ["Olive oil", "Vegetable oil", "Canola oil", "Sunflower oil",
    "Sugar", "Brown sugar", "Honey", "Maple syrup", "Salt", "Pepper",
    "Plain flour", "Self-raising flour", "Cornstarch", "Baking powder",
    "Breadcrumbs", "Ketchup", "Tomato paste", "Tomato sauce", "Passata",
    "Peanut butter", "Tahini", "Tinned San Marzano tomatoes",
    "Tinned chopped tomatoes", "Canned tomatoes", "Creamed corn", "Boiling water",
    "Chicken stock", "Chicken broth", "Vegetable stock", "Vegetable broth",
    "Beef stock", "Cocoa powder", "Condensed milk", "Nutritional yeast",
    "Vanilla extract", "Cinnamon", "Cumin", "Coriander powder", "Turmeric",
    "Paprika", "Smoked paprika", "Chili powder", "Oregano", "Dried oregano",
    "Dried thyme", "Bay leaf", "Za'atar", "Sumac", "Harissa", "Ras el hanout",
    "Garam masala", "Curry powder", "Dijon mustard", "Mustard",
    "Worcestershire sauce", "Hot sauce", "BBQ sauce", "Vinegar",
    "Apple cider vinegar", "Red wine vinegar", "Capers"],
  "Grains & Noodles": ["Arborio rice", "Japanese short-grain rice", "Jasmine rice",
    "Basmati rice", "Long-grain rice", "White rice", "Sushi rice",
    "Cooked jasmine rice", "Cooked Japanese short-grain rice", "Cooked rice",
    "Penne or fusilli pasta", "Penne pasta", "Fusilli pasta", "Spaghetti",
    "Macaroni pasta", "Macaroni", "Orzo pasta", "Stelline / small pasta",
    "Fresh potato gnocchi", "Flatbread / naan", "Naan bread", "Pita bread",
    "Bread", "Sliced bread", "Baguette", "Sourdough",
    "Flour tortillas", "Corn tortillas", "Tortilla wraps", "Tortillas",
    "Udon noodles", "Fresh egg noodles", "Thin egg noodles",
    "Thin egg noodles or somen", "Rice noodles", "Flat rice noodles",
    "Glass noodles", "Sweet potato noodles", "Japchae noodles",
    "Yakisoba noodles", "Vermicelli", "Rice paper wrappers",
    "Wonton wrappers", "Dumpling wrappers", "Gyoza wrappers",
    "Couscous", "Semolina", "Quinoa", "Bulgur wheat",
    "Puff pastry", "Phyllo pastry", "Filo pastry", "Pie crust",
    "Taco shells", "Grape leaves"],
  "Frozen": ["Frozen edamame", "Frozen peas", "Frozen peas and corn", "Sweet corn",
    "Frozen corn", "Frozen spinach", "Frozen berries", "Frozen mango"],
  "Asian & World Specialty": ["Soy sauce", "Soy sauce (light)", "Light soy sauce",
    "Dark soy sauce", "Mirin", "Sesame oil", "Sesame seeds", "Rice vinegar",
    "Dashi stock powder", "White miso paste", "Miso paste",
    "Nori sheets", "Nori strips", "Dried wakame",
    "Panko breadcrumbs", "Tonkatsu sauce", "Okonomiyaki sauce", "Yakisoba sauce",
    "Bonito flakes", "Japanese curry roux", "Coconut milk", "Coconut cream",
    "Japanese mayonnaise", "Fish sauce", "Oyster sauce",
    "Gochujang", "Gochugaru", "Doenjang",
    "Tamarind paste", "Curry paste", "Green curry paste", "Red curry paste",
    "Lemongrass paste", "Galangal", "Kaffir lime leaves",
    "Tteok", "Rice cakes", "Tapioca starch", "Cassava flour",
    "Palm sugar", "Jaggery", "Ghee",
    "Dried shrimp", "Shrimp paste", "Hoisin sauce",
    "Sriracha", "Sambal", "Chili garlic sauce",
    "Star anise", "Five spice powder", "Cardamom",
    "Saffron", "Preserved lemon"]
};
